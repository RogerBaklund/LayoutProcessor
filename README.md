...
output **instead** **of** any output generated from the PHP code. This output must be possible to convert
to a string, which means it can not be an array and it can only be an object if the object has a 
`__toString()` method.
